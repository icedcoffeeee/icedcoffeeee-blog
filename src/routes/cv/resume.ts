...
export const specials = {
  Physics: "Laser Physics, Optical Fibres and Waveguides, Semiconductor Physics, Material Junctions, Gas Discharge, Plasma Physics, Computational Simulation, Neural Networks.",
...
export default {
  ...
  experience: [
    ...
    },
    {
      ...
      location: "University of Malaya",
      lists: [
        "Research topic: Utility of Open Source Software in Science.",
      ]
    },
    {
